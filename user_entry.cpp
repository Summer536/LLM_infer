...
struct ConvertedModel {
    std::string model_path = "/home/yqgao/llamaweight/1-gpu/"; // 模型文件路径
    std::string tokenizer_path = "/home/yqgao/LLM_inference/Pandas_0803/LLM-engineering/llama2-7b-tokenizer.bin"; // tokenizer文件路径
};
